...
CREATE TYPE rank_class AS ENUM ('none', 'nco', 'command', 'clan');
CREATE TYPE branch AS ENUM ('army', 'navy', 'marine corps', 'air force');

CREATE TABLE IF NOT EXISTS ranks (
    id SERIAL NOT NULL,
    grade_id INT NOT NULL,
    branch branch DEFAULT 'army',
    classification rank_class DEFAULT 'none',
...
INSERT INTO
    ranks (grade_id, classification, name, abbreviation, image_uri)
VALUES
    ...
    (5, 'nco', 'Corporal', 'CPL', '/images/e4-cpl.png'),
    (6, 'nco', 'Sergeant', 'SGT', '/images/e5-sgt.png'),
    (7, 'nco', 'Staff Sergeant', 'SSG', '/images/e6-ssg.png'),
    (8, 'nco', 'Sergeant First Class', 'SFC', '/images/e7-sfc.png'),
    (9, 'nco', 'Master Sergeant', 'MSG', '/images/e8-msg.png'),
    (9, 'command', 'First Sergeant', '1SG', '/images/e8-1sg.png'),
    (10, 'nco', 'Sergeant Major', 'SGM', '/images/e9-sgm.png'),
    (10, 'command', 'Command Sergeant Major', 'CSM', '/images/e9-csm.png'),
